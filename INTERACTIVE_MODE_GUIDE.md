...
| Output | `workspaces/<ws>/logs/*.jsonl` | Same logs, shown live in the browser via the visualizer |
...
You can also open any workspace in the **standalone read-only viewer**:
