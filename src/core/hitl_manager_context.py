...
class HitlManagerContext:
    ...
    def append_message(
        self, *, role: str, content: str, speaker: str, visible_to_human: bool
    ) -> Dict[str, Any]:
        ...
        return self._append(
            {
                ...
                "speaker": speaker,
                "content": content,
                "visible_to_human": bool(visible_to_human),
            }
        )
...
class HitlManagerTranscript:
    ...
    def append(
        self, speaker: str, content: str, *, visible_to_human: bool | None = None
    ) -> Dict[str, Any]:
        ...
        visible = normalized == "human" if visible_to_human is None else bool(visible_to_human)
        record = self.context.append_message(
            role=role, content=content, speaker=normalized, visible_to_human=visible
        )
