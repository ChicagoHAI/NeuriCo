...
def main(argv: List[str] | None = None) -> int:
    ...
    try:
        ...
        return command_error("hitl-raise-idea", str(exc), EXAMPLE)
    except HitlToolClientError as exc:
        return fail("hitl-raise-idea", exc)
    print("HITL_RESOLVED")
