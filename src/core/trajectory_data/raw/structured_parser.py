...
@dataclass(frozen=True)
class ParsedError:
    """One parse issue associated with a source file or physical line."""
...
@dataclass
class ParseResult:
    """Complete result of parsing one structured file."""
    ...
    @property
    def status(self) -> str:
        """Map parser output to source_files.parse_status."""
