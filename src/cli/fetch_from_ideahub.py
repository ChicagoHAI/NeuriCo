...
_DOMAIN_KEYWORDS = {
    ...
    'particle_physics': ['bsm', 'beyond standard model', 'standard model', 'higgs', 'supersymmetry', 'susy',
                         'dark matter', 'wimp', 'neutrino', 'sterile neutrino', 'axion', 'alp',
                         'lepton flavor', 'flavor violation', 'cp violation', 'parton',
                         'gauge boson', 'electroweak', 'collider', 'lhc', 'hl-lhc', 'fcc',
                         'belle ii', 'dune', 'hyper-k', 'icecube', 'lz', 'xenon',
                         'madgraph', 'feynrules', 'pythia', 'delphes', 'micromegas',
                         'feynman', 'cross section', 'branching ratio', 'hierarchy problem',
                         'hidden sector', 'dark photon', 'effective field theory', 'smeft',
                         'seesaw', 'leptoquark', 'muon g-2', 'edm', 'cmb-s4', 'snowmass',
                         'particle physics', 'high energy physics', 'hep-ph', 'hep-ex'],
